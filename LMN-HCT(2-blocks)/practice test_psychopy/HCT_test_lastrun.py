...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='D:\\毕业论文\\26年5月实验二\\LMN-HCT(2-blocks)\\practice test_psychopy\\HCT_test_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    welcome_textbox = visual.TextBox2(
         win, text='欢迎您参与我的实验！\n\n在开始前请确认以下内容：\n\n请调整姿势，在骑行过程中上半身尽量不要动。\n这项任务很简单，但请认真遵守。', placeholder='Type here...', font='Microsoft YaHei',
    ...
    introducion_textbox = visual.TextBox2(
         win, text='心跳计数任务\n\n实验中，会让你试着去感受你的心跳，不是主动地感觉(触摸)你的手腕或脖子的脉动。你可能有感觉，也可能根本感觉不到，或者偶尔会有一些感觉。\n\n当听到第一个信号时，请将注意放到你的心跳上；5s后将会出现第二个信号，请你开始数你感觉到的心跳。当听到第三个信号时，请停止数心跳并输入你数的数量以及对你的自信心进行打分。（认真感受和自省评分，若多次信心相同、明显敷衍，被试费将被扣除）\n\n对这项任务，不要试图猜测你的心率。请忽视外界噪音、自行车噪音的节律，认真聆听、感受身体节律。\n\n如果对实验有何问题，及时询问主试。如果已经理解，点击键盘任意按键进入实验。', placeholder='Type here...', font='Microsoft YaHei',
